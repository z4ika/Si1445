...
{
    HAL_I2C_Mem_Write(&hi2c1, SI1145_PARAM_ADDR, SI1145_REG_COMMAND, I2C_MEMADD_SIZE_8BIT , SI1145_PARAM_QUERY, 1, 100);
...
{
    // Enable coefficients
    HAL_I2C_Mem_Write(&hi2c1, SI1145_PARAM_ADDR, SI1145_REG_UCOEFF0, I2C_MEMADD_SIZE_8BIT , (uint8_t*) 0x29, 1, 100);
    HAL_I2C_Mem_Write(&hi2c1, SI1145_PARAM_ADDR, SI1145_REG_UCOEFF1, I2C_MEMADD_SIZE_8BIT , (uint8_t*) 0x89, 1, 100);
    HAL_I2C_Mem_Write(&hi2c1, SI1145_PARAM_ADDR, SI1145_REG_UCOEFF2, I2C_MEMADD_SIZE_8BIT , (uint8_t*) 0x82, 1, 100);
    HAL_I2C_Mem_Write(&hi2c1, SI1145_PARAM_ADDR, SI1145_REG_UCOEFF3, I2C_MEMADD_SIZE_8BIT , (uint8_t*) 0x00, 1, 100);

    // Measurement rate setting for auto mode
    HAL_I2C_Mem_Write(&hi2c1, SI1145_PARAM_ADDR, SI1145_REG_MEASRATE0, I2C_MEMADD_SIZE_8BIT , (uint8_t*) 0xFF, 1, 100);
    ...
    HAL_I2C_Mem_Write(&hi2c1, SI1145_PARAM_ADDR, SI1145_REG_INTCFG, I2C_MEMADD_SIZE_8BIT ,  SI1145_REG_INTCFG_INTOE, 1, 100);
    HAL_I2C_Mem_Write(&hi2c1, SI1145_PARAM_ADDR, SI1145_REG_INTCFG, I2C_MEMADD_SIZE_8BIT ,  SI1145_REG_IRQEN_ALSEVERYSAMPLE, 1, 100);
...
void si1145_reset()
{
    ...
    HAL_I2C_Mem_Write(&hi2c1, SI1145_PARAM_ADDR, SI1145_REG_HW_KEY, I2C_MEMADD_SIZE_8BIT, (uint8_t*) 0x17, 1, 100);
}
...
{
    if (HAL_I2C_IsDeviceReady(&&hi2c1, SI1145_PARAM_ADDR, SI1145_REG_COMMAND, I2C_MEMADD_SIZE_8BIT, 100) != 1)
    {
        return false;
    }
    else
